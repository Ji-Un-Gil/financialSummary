...
2026-09-18 기준 Worker 배포, ChatGPT OAuth 연결, 수동·무인 예약의 GitHub 시험 저장을 확인했다. 매일 18:30 Asia/Seoul 뉴스 예약에는 같은 실행 안에서 보고서와 검증표를 저장하도록 설정했다. 9월 18일 첫 뉴스 예약은 필수 지침의 웹 접근 오류로 저장 전에 중단됐다. 지침 원문을 내장한 예약으로 수정했고, 같은 클라우드 대화에서 수동 재실행한 보고서의 실제 저장 성공을 확인했다. 다음 정시 무인 실행은 별도 확인 대상이다. [장애 조사 기록](../../docs/incident-2026-09-18.md).
